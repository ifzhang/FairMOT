...
if __name__ == '__main__':
    ...
    data_train = '/data/yfzhang/MOT/JDE/crowdhuman/images/val'
    label_train = '/data/yfzhang/MOT/JDE/crowdhuman/labels_with_ids/val'
    ann_train = '/data/yfzhang/MOT/JDE/crowdhuman/annotation_val.odgt'
